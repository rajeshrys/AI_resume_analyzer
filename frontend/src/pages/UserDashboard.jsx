...
console.log(loading)
  ...
  <button onClickCapture={()=>setloading(true)} onClick={handlesubmit} className='p-3 mt-4 rounded-xl text-white font bold bg-purple-700 w-[150px] active:scale-95 cursor-pointer'>Submit</button>
  </div>
  {loading && (
